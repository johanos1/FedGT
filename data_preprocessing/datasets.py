...
class Data_Manager:
    ...
    def get_client_dl(self, dataidxs, attacks=None):
        ...
        #if len(dataidxs) % self.train_bs == 1:
        client_dl = DataLoader(client_ds, batch_size=self.train_bs, drop_last=True) #added True one
        #else:
    ...
    def get_validation_dl(self):
        ...
        val_dl = DataLoader(val_ds, batch_size=self.test_bs) #self.train_bs
        return val_dl
